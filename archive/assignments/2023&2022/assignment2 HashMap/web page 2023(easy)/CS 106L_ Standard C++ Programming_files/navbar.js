                ...
                <div class="navbar-nav">
                    <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                              ...
                              <a class="dropdown-item" style="font-family:Jost;" href="assignment1.html">Assignment 1: WikiRacer Part 1</a>
                              <a class="dropdown-item" style="font-family:Jost;" href="assignment2.html">Assignment 2: WikiRacer Part 2</a>
                              <a class="dropdown-item" style="font-family:Jost;" href="assignment3.html">Assignment 3: STL HashMap</a>
                              </div>
                          </li>
                    ...
                    <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="margin-left=-3px;">
                              ...
                              <a class="dropdown-item" style="font-family:Jost;" href="https://edstem.org/us/courses/16784/discussion/">EdStem (for Enrolled Students)</a>
