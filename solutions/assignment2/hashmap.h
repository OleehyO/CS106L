...
private:
    ...
    */
    using node_pair = std::pair<typename HashMap::node_ptr, typename HashMap::node_ptr>;
    ...
    * Hint: on the assignment, you should NOT need to call this function.
    */
    iterator make_iterator(node_ptr curr) const;
    ...
    */
    std::vector<node_ptr> _buckets_array;
