...
private:
     ...
     */
    HashMapIterator(bucket_array_type* buckets_array, node_ptr node, size_t bucket);

};


template <typename Map, bool IsConst>
HashMapIterator<Map, IsConst>::HashMapIterator(bucket_array_type* buckets_array, node_ptr node,
    size_t bucket) :
