...
bool valid_wikilink(const string& link) {
    // replace these lines!
    std::function<bool(char)> is_valid = [](char c) { return c != '#' && c != ':';};
    return std::all_of(link.begin(), link.end(), is_valid);
}
...
unordered_set<string> findWikiLinks(const string& inp) {
    ...
    while(true) {
        ...
        auto url_end = std::find(link_start + delim.size(), end, '"');
        // END STUDENT CODE HERE
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        // BEGIN STUDENT CODE HERE (delete/edit this line)
        string link = string(link_start + delim.size(), url_end);
        // END STUDENT CODE HER
        ///////////////////////////////////////////////////////////////////////////////////////////////////
